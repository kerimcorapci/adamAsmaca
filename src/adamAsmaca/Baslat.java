...
public class Baslat {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1. Bir kelime gurubundan rastgele bir kelime seçilir.
		 * 	//örnek kelime ayna
		 * 2. Seçilen kelimenin harf sayııs kadar * veya istenen işareti basar
		 * 	//****
		 * 3.Kullanıcı harf tahmini yapar
		 * 	a.Harf varsa, harfin yerini girilen harfe dönüştürür.
		 * 	//a**a
		 * 	b. Harf yoksa deneme sayısı bir artar
		 * 	c. Eğer harf sayısı 10 olursa oyun biter. Sonra 5. Adıma gider
	...
	private static int harfDeneme(Scanner scanner, int denemeSayisi, boolean kelimeyiBildiMi, String secilenKelime,
		...
		while (!kelimeyiBildiMi && denemeSayisi<10) {
			...
			if (!sonuc) {
				...
				denemeSayisi++;
				System.out.println(denemeSayisi + ". yanlıs deneme");
			}
	...
	static char[] kelimeyiDonustur(String kelime,char sembol) {
		//Hangi kelimeyi hangi işarete dönüştürecek
		//ayna
		//****
